...
public class VideoCapService extends Service {
	...
	public boolean onUnbind(Intent intent) {
		Log.w(Tag, "VideoCapService onUnbind...");
	...
	public void onDestroy() {
		...
		Log.w(Tag, "VideoCapService onDestroy...");
	 ...
	 * @throws Exception
	 */
	public void reStartVideoCapture(SurfaceHolder surfaceHolder, short resolution, boolean portrait) throws Exception {
		stopVideoCapture();
		startVideoCapture(surfaceHolder, resolution, portrait);
	}
	...
	public void startVideoCapture(SurfaceHolder surfaceHolder, short resolution, boolean portrait) throws Exception {
		...
		Log.i(Tag, "VideoCapService VideoCapture.start(surfaceHolder, w, h, maxFPS, d.getRotation())");
	...
	public void stopVideoCapture() throws Exception {
		...
		Log.i(Tag, "VideoCapService VideoCapture.stop()");
