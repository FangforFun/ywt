...
public class LoginPresenter implements LoginContract.Presenter {
    ...
    public void sendVerifyCode(@NonNull EditText editText) {
        ...
        mVerifySubscription = LoginWrap.getInstance().sendVerifyCode(OkHttpUtils.getRequestBody(phone_str), new SimpleObserver<ResponseBody>(){
            @Override
            ...
            public void onNext(ResponseBody responseBody) {
                ...
                try {
                    ...
                    if (result.contains(mContext.getString(R.string.code_200))){
                        loginContractView.showToast("已发送");
                        return;
                    }
