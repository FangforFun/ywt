...
public class UserInfoActivity extends BaseActivity {
    ...
    private final String[] USER_INFO_LEFT_TVS = {"姓名", "身份证号",  "与服刑人员关系","服刑人员性别", "服刑人员囚号", "服刑人员刑期", "联系电话"};
    private final String[] USER_INFO_RIGHT_TVS = {"叶美惠", "34523423423423534", "女", "母子", "217459123", "3年3个月", "13232324328"};
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (position){
                case 0:// 姓名
                    ...
                    break;
                case 1:// 身份证号
                    holder.tv_user_info_right.setText(sp.getString("password", ""));
                    break;
                case 3:// 服刑人员性别
