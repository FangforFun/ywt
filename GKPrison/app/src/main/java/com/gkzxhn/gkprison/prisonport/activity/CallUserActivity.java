...
public class CallUserActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        if(image_url.contains("|")) {
            ...
            bitmapUtil.display(iv_id_card_01, "http://10.93.1.10:3000" + img_urls[0]);
            bitmapUtil.display(iv_id_card_02, "http://10.93.1.10:3000" + img_urls[1]);
            Log.i("tupian", "http://10.93.1.10:3000" + img_urls[0] + "---" + "http://10.93.1.10:3000" + img_urls[1]);
        }
