package com.gkzxhn.gkprison.widget.view.calendar;
...
public class CalendarCard extends View {
    ...
    private void init(Context context) {
        ...
        mCirclePaint.setColor(context.getResources().getColor(R.color.theme)); // 红色圆形
...
//                    State.TODAY, rows[row].cells[col].i,
    ...
    class Cell {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            canvas.drawText(content, (float) ((i + 0.5) * mCellSpace - mTextPaint.measureText(content) / 2), (float) ((j + 0.7) * mCellSpace - mTextPaint.measureText(content, 0, 1) / 2), mTextPaint);
        }
    }
