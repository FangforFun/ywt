...
public class SQLitehelp extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE line_items(id INTEGER AUTO_INCREMENT,Items_id INTEGER(60),cart_id INTEGER,qty INTEGER(60),total_money VARCHAR2(60),positon INTEGER(60),price varchar[255],title varchar(255))");
