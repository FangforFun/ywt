...
public class LawsRegulationsActivity extends BaseActivityNew {
    ...
    private static final java.lang.String TAG = LawsRegulationsActivity.class.getSimpleName();
    ...
    private void getLawsAndRegulations() {
        if (!SystemUtil.isNetWorkUnAvailable()){
            ...
            getLawsSubscription = apiRequest.getLawsAndRegulationsList(jail_id, token).subscribeOn(Schedulers.io())
