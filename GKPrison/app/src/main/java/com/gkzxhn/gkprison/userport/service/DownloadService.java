package com.gkzxhn.gkprison.userport.service;
...
public class DownloadService extends Service {
    ...
    // 返回的安装包url
    private String apkUrl = "http://www.fushuile.com/dist/android/1.0.0/app-release.apk";
    ...
    private static final String saveFileName = savePath + "ywt_AppUpdate.apk";
...
//        setForeground(true);// 这个不确定是否有作用
    ...
    public class DownloadBinder extends Binder {
        ...
        public void addCallback(VersionUpdateActivity.ICallbackResult callback) {
    ...
    private void setUpNotification() {
        ...
        contentView.setTextViewText(R.id.name, "app-release.apk 正在下载...");
        // 指定个性化视图
